...
anova(Levene.model.a) # P = 0.48


# Test for normal distribution of residuals
shapiro.test(residuals(model.a)) # P = 0.4599
...
#factor(Hydro)                     1     2   4.12511  0.1793
#ordered(Season)                   1    26   0.05636  0.8142
#factor(Hydro):ordered(Season)     1    26   15.2203  0.0006
...
# Test for normal distribution of residuals
shapiro.test(residuals(model.b)) # P = 0.9258
